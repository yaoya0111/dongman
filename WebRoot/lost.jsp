        ...
        <TR>
          <TD><FORM name="form1" action="<%=basePath%>Member" method="post">
            ...
            <TBODY>
              ...
              <INPUT type=hidden  name="method" value="lostpwd"> 
              <TR >
                <TD align=right width="38%"  height=30>用 户 名:</TD>
                <TD width="62%"  height=30 align=left>
				<INPUT class=inputb  size=22 name=username required>
				</TD>
				</TR>
              <TR class=black >
                <TD align=right width="38%"  height=30>提示问题:<input type=hidden name=reg_type value=person></TD>
                <TD width="62%"  height=30 align=left>
				<INPUT class=inputb   size=22 name=question required>
				</TD>
				</TR>
              <TR class=black >
                <TD align=right width="38%"  height=30>问题答案:</TD>
                <TD width="62%"  height=30 align=left>
				<INPUT class=inputb  size=22 name=answer required> 
				</TD>
				</TR>
              <TR class=black >
                <TD align=center  colSpan=2 height=40><input type=submit value="提交信息"> 　 </TD>
				</TR>
