     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<TD  class=middle align="left" >
               <TABLE class=xsnr id=tb1_nr1  cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    String jg1=request.getParameter("jg1");
                    String jg2=request.getParameter("jg2");
                    cb.setEVERYPAGENUM(6);
		int cou = cb.getMessageCount("select count(*) from sale where dh='"+dh+"' and title like '%"+title+"%' and dz>='"+jg1+"' and dz<='"+jg2+"'");//得到信息总数			        
		...
		List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from sale where dh='"+dh+"' and title like '%"+title+"%' and dz>='"+jg1+"' and dz<='"+jg2+"' order by id desc",11); //带进一个页数，并返回该页所要显示的信息 
