...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
  <TR>
    <TD align="left" vAlign=top ><form action="<%=basePath %>GuestBook?method=delguestbook" method="post" name="pageform">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<%
			...
			int cou = lb.getMessageCountM();//得到信息总数			        
			...
			List pagelist1 = lb.getMessageM(Integer.parseInt(page1)); //带进一个页数，并返回该页所要显示的信息 
		  ...
		  <TR align="center" bgColor=#ffffff>
			...
			<TD id=map><a href="<%=basePath %>ComServlet?method=delgbook&id=<%=pagelist2.get(0).toString()%>">删除</a></TD>
		  </TR>
		<%}%>    	
