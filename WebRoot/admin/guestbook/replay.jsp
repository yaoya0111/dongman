...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
	...
	<form action="<%=basePath %>GuestBook" method="post" name="form1" onSubmit="return check()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  <TBODY>
		  <TR align="center" class=head>
			<TD colspan="2" height=23>回复</TD>
		  </TR>
		 <TR align="center" bgColor=#ffffff><input type="hidden" name="id" value="<%=id %>" ><input type="hidden" name="method" value="<%=method %>" >
			<TD width="30%" align="right" >内容：</TD><TD width="70%" align="left" id=map><textarea name="reasons" cols="50" rows="5" readonly><%=content %></textarea></TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >回复：</TD><TD width="70%" align="left" id=map><textarea name="replay" cols="50" rows="5" ><%=replay %></textarea></TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
