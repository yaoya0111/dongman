...
<TABLE  cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD align="left" vAlign=top >
	  ...
	  <form action="<%=basePath %>admin/prep/s1info.jsp" method="post" name="form2"  >  
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  <TBODY> 
		  <TR align="center" class=head>
			<TD  align="center" >订单地区统计 </TD>
		  </TR> 
		  <TR align="center" bgColor=#ffffff>
			<TD  align="center" >地区信息：<select name="dq">
    ...
    起始日期：<input type=date size=20 name=ksj required>
			 -  <input type=date size=20 name=esj  required> 
