...
<form name="form1" action="<%=basePath %>ComServlet?method=addFenLei" method="post"  >
<p align=center>分类名称：<input name="bj" type="text" size="30" maxlength="100" required> 
<input class=mmcinb type='submit' name='s' value='提交数据'  >
</form>	
</BODY>
<%} %>
</HTML>
