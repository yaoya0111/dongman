...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="40%" border=0>
  ...
  <TR>
	...
	<form action="<%=basePath %>Member" method="post" name="form1"  >
		 <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
			<TBODY>
			<TR class=head>
			<TD colSpan=2 height=23>修改后台登录密码 当前用户：<FONT color=red><%=member %></FONT> </TD></TR>
			<TR bgColor=#ffffff>
			...
			<TD width="50%" align="left" id=map><input type="password" name="newpwd" size="20" id="newpwd" onchange="checkPasswords()"  maxlength=16 class=input required></TD>
			</TR>
			<TR bgColor=#ffffff>
			...
			<TR bgColor=#ffffff>
			<TD colspan="2" align="center" id=map><input type="submit" value="确定"> </TD>
			</TR>
			</TBODY>
		</TABLE>
	</form>
