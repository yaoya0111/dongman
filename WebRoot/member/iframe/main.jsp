...
<%
	...
	int sum=0;
	 List jflist=cb.getCom("select sid,sl from lb where member='"+member+"' and zt!='未提交'",2);
	 if(!jflist.isEmpty()){
...
<br><br><br><br><br><p align=center><font color=red><strong>欢迎您，尊敬的会员：<%=member %> 您目前积分：<%=sum %></strong></font>
	</BODY>
<%} %>
</HTML>
