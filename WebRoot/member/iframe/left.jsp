...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=basePath %>member/prep/tj.jsp" target="MainFrame">订单信息查看</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=basePath %>member/prep/s.jsp" target="MainFrame">订单信息查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
