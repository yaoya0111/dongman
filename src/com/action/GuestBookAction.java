	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String method = request.getParameter("method").trim();
			...
			if(method.equals("add")){//发表留言
				...
				String email = "images/nobody.gif";
				String qq = "images/nobody.gif";
				String weburl = "images/nobody.gif";
				String blogurl = "images/nobody.gif";
				String expressions = "images/nobody.gif";
