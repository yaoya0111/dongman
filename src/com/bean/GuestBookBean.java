...
public class GuestBookBean {
	...
	private String sql2="select * from guestbook where ifhide='1' order by id desc ";
    ...
    public int getMessageCountM( ) { //得到信息总数
    	String sql3=null;
    ...
    public List getMessageM(int page ) { //得到每页要显示的信息
    	String sql4=null;
         
        	sql4="select * from guestbook order by id desc ";
